...
$id = $_GET['id'] ?? "";
  ...
  $rezultat = mysqli_query($con, $sql4);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		...
		$sql3 = "UPDATE tbl_product SET name='".$_POST['name']."', description='".$_POST['description']."', price='".$_POST['price']."', code='".$_POST['code']."', image='".$_POST['image']."' WHERE id='".$id."' LIMIT 1";
		$result = mysqli_query($con, $sql3);
		if($result) {
			header("Location: gestionare_produse.php");
		}
		else {
			echo "Eroare la editarea produsului.";
		}
}
...
<form class="form-horizontal" action="product_edit.php?id=<?php echo $id; ?>" method="post">
